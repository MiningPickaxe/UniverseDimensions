...
public class UniverseDimPortal extends BlockBreakable
{
    public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};

    public UniverseDimPortal()
    {
        super(Main.MODID + ":portal", Material.portal, false);
    ...
    public static boolean func_150000_e(World p_150000_1_, int p_150000_2_, int p_150000_3_, int p_150000_4_)
    {
        UniverseDimPortal.Size size = new UniverseDimPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        UniverseDimPortal.Size size1 = new UniverseDimPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        UniverseDimPortal.Size size = new UniverseDimPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        UniverseDimPortal.Size size1 = new UniverseDimPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP))){
        	...
        	}else if(player.dimension != Main.dimid) {
        		player.timeUntilPortal = 10;
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player, Main.dimid, new UniverseDimTeleporter(mcserver.worldServerForDimension(Main.dimid)));
        	}else{
        		player.timeUntilPortal = 10;
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new UniverseDimTeleporter(mcserver.worldServerForDimension(0)));
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        {
            p_149734_1_.playSound((double)p_149734_2_ + 0.5D, (double)p_149734_3_ + 0.5D, (double)p_149734_4_ + 0.5D, "random.fizz", 0.5F, p_149734_5_.nextFloat() * 0.4F + 0.8F, false);
        }
        ...
        for (int l = 0; l < 4; ++l)
        {
            ...
            p_149734_1_.spawnParticle("reddust", d0, d1, d2, d3, d4, d5);
        }
    }
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                this.field_150863_d = UniverseDimPortal.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = UniverseDimPortal.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
            {
                ...
                block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
                return block == Main.portalstone ? i1 : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[UniverseDimPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[UniverseDimPortal.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[UniverseDimPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[UniverseDimPortal.field_150001_a[this.field_150865_b][0]]);
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[UniverseDimPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[UniverseDimPortal.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[UniverseDimPortal.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[UniverseDimPortal.field_150001_a[this.field_150865_b][1]];

                    if (this.field_150867_a.getBlock(j, k, l) != Main.portalstone)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Main.portalmaker || p_150857_1_ == Main.portal;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    for (int l = 0; l < this.field_150862_g; ++l)
                    {
                        ...
                        this.field_150867_a.setBlock(j, i1, k, Main.portal, this.field_150865_b, 2);
                    }
                }
            }
        }
